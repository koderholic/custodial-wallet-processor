...
func TestV2SubscribeAddress(t *testing.T) {
	...
	addressArray := []string{"bc1qq65rn0wzjnmcwqz4jp0cx48lvj7ynectmw60jj"}
	subs[configTest.BtcSlipValue] = addressArray
	uuid, _ := uuid.FromString("7987452c-f2e5-4ed4-a6a3-98a57915cec4")
	requestData := dto.SubscriptionRequestV2{
		Subscriptions: subs,
		UserId:        uuid,
	}
	subscriptionResponseData := dto.SubscriptionResponse{}
	...
	services.SubscribeAddressV2(authCache, logger, configTest, requestData, &subscriptionResponseData, serviceErr)
